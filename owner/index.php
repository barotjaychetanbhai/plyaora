...
<div class="flex-1 flex flex-col h-screen overflow-hidden relative">
    ...
    <main class="flex-1 overflow-y-auto p-4 md:pt-0 pt-0 relative z-0">
        <div class="glass-card min-h-full p-6 transition-all duration-300" id="content">
            <?php
            $allowedPages = ['dashboard', 'turfs', 'add-turf', 'edit-turf', 'turf-slots', 'bookings', 'earnings', 'profile', 'scan-ticket'];
            ...
            if (in_array($page, $allowedPages)) {
                ...
                if (file_exists($file)) { 
                    ...
                    echo "<div class='text-center py-12'>
                            ...
                            <h3 class='text-xl text-emerald-400 font-semibold mb-2'>404 - Page under construction</h3>
