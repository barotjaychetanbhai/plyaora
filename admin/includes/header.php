<header class="h-16 glass-card m-4 mb-0 ml-0 md:ml-0 md:mr-4 flex items-center justify-between px-6 shrink-0 w-full md:w-auto md:flex-1">
    ...
    <div class="flex items-center gap-4">
        <button class="text-gray-400 hover:text-white transition-colors relative">
            ...
            <span class="absolute -top-1 -right-1 w-2.5 h-2.5 bg-red-500 rounded-full border-2 border-[#1a1a1c]"></span>
        </button>
        <div class="h-9 w-9 rounded-full bg-gradient-to-tr from-purple-500 to-blue-500 flex items-center justify-center text-sm font-bold shadow-lg text-white border border-white/10 cursor-pointer">
            A
        </div>
    </div>
</header>
